...
public class ProjectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProjectAdapter(List<ProjectData> serviceslist, Context con) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        ...
        if (position == 0) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.project_style, viewGroup, false);
